...
| `paper/paper_figures.ipynb` | `reports/figures/` | Single top-to-bottom notebook that renders every manuscript figure (Pareto fronts, rediscovery overlay, flown-rover validation) from the artifacts above. Runs in well under a minute. |
...
~10 minutes. With both in place, `paper/paper_figures.ipynb`
